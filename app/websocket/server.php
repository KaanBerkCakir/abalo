...
require __DIR__ . '/../../vendor/bloatless/php-websocket/src/Application/SaleApplication.php';
...
$server->registerApplication('maintenance', \Bloatless\WebSocket\Application\DemoApplication::getInstance());
$server->registerApplication('sale', \Bloatless\WebSocket\Application\SaleApplication::getInstance());
